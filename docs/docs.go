...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_appointment.CreateAppointmentInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/clinic-management-api_internal_database.Appointment"
                        }
                    }
                }
            }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_appointment.UpdateStatusInput"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/clinic-management-api_internal_database.Doctor"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/clinic-management-api_internal_database.Patient"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        "clinic-management-api_internal_database.Appointment": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "clinic-management-api_internal_database.Doctor": {
            "type": "object",
            "properties": {
                "bio": {
                    "type": "string"
                ...
                "specialization": {
                    "$ref": "#/definitions/clinic-management-api_internal_database.Specialization"
                },
                "specializationID": {
                    "type": "integer"
                },
                ...
                "user": {
                    "$ref": "#/definitions/clinic-management-api_internal_database.User"
                },
                "userID": {
                    "type": "integer"
                }
        ...
        "clinic-management-api_internal_database.Patient": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "clinic-management-api_internal_database.Specialization": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "clinic-management-api_internal_database.User": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
                ...
                "role": {
                    "description": "ADMIN, DOCTOR, STAFF, PATIENT",
                    "type": "string"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "internal_appointment.CreateAppointmentInput": {
            "type": "object",
            "required": [
                "doctor_id",
                "schedule_date"
        ...
        "internal_appointment.UpdateStatusInput": {
            "type": "object",
            "required": [
                "status"
            ],
